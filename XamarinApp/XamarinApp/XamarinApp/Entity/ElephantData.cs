    ...
    public static class ElephantData
    {
        ...
        static ElephantData()
        {
            ...
            Elephants.Add(new Animal
            {
                Name = "Voi Việt Nam",
                Location = "Asia",
                Details = "Voi Việt Nam là quần thể voi sinh sống, phân bố tại Việt Nam, gắn bó với đời sống, lịch sử, văn hóa của cộng đồng các dân tộc Việt Nam. Voi Việt Nam thuộc nhóm voi châu Á và là loài động vật từng phân bố khắp các vùng miền ở Việt Nam, gắn bó với sản xuất, chiến đấu và văn hóa của các dân tộc ở Việt Nam. Tuy nhiên, hiện tại voi hoang dã đang trong tình trạng nguy ngập và chỉ hay xuất hiện ở Tây Nguyên, đặc biệt là Đắk Lắk.",
                ImageUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/d/da/Voi_t%E1%BA%A1i_B%C3%ACnh_D%C6%B0%C6%A1ng.jpg/450px-Voi_t%E1%BA%A1i_B%C3%ACnh_D%C6%B0%C6%A1ng.jpg"
            });
